...
public class Constants {
	...
	// Browser paths
	public static final String CHROME_PATH = "src"+File.separator+"test"+File.separator+"resources"+File.separator+"drivers"+File.separator+"chromedriver";
	public static final String FIREFOX_PATH = "src"+File.separator+"test"+File.separator+"resources"+File.separator+"drivers"+File.separator+"geckodriver";
